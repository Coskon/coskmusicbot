...
if True: # only to minimize
    ...
    tuning_embed_title = "Tuning information"
    ...
    volume_title = "Volume changed"
    volume_desc = "➤ **Volume**: %vol"
    eq_title = "Equalization"
...
if True: # only to minimize
    ...
    tuning_embed_title = "Información de afinación"
    ...
    volume_title = "Volúmen cambiado"
    volume_desc = "➤ **Volúmen**: %vol"
    eq_title = "Ecualización"
